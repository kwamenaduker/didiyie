...
import 'package:didiyie/didiyie_page/didiyie_homepage/didiyie_orderdone.dart';
...
class didiyieOrderAlmostready extends StatefulWidget {
  const didiyieOrderAlmostready({Key? key}) : super(key: key);

  @override
  State<didiyieOrderAlmostready> createState() => _didiyieOrderAlmostreadyState();
}

class _didiyieOrderAlmostreadyState extends State<didiyieOrderAlmostready> {
  dynamic size;
  double height = 0.00;
  double width = 0.00;
              ...
              Container(
                ...
                child:Column(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.symmetric(horizontal: width/36),
                      child: Text("Your order is",style: mulishsemiBold.copyWith(fontSize: 18,color: didiyieColor.lightappcolor),),
                    ),
                    SizedBox(height: height/56,),
                    Padding(
                      padding:EdgeInsets.symmetric(horizontal: width/36),
                      child: Text("almost ready",style: mulishbold.copyWith(fontSize: 18,color: didiyieColor.yellow),),
                    ),
                    SizedBox(height: height/36,),
                    Image.asset(didiyiePngimage.orderstatus2,width: width/1,fit: BoxFit.fitWidth,)
                  ],
                ),
